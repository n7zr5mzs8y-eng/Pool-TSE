...
exports.handler = async (event) => {
  try {
    // Selon le type de redirection (avec ou sans joker "*"), Netlify peut
    // fournir soit le chemin réécrit (/.netlify/functions/px/nhl/...),
    // soit le chemin d'origine tel que vu par le navigateur (/nhl/..., /bin, /blob).
